...
pessoa = Pessoa('Anna Lucia', 17, 'Estudante')
...
conta1 = ContaBancaria('João Schilian', 50.000)
conta2 = ContaBancaria('Murilo Camillo', 75.000)
...
conta = ContaBancaria('Anna Lucia', 80.000)
...
cliente1 = ClienteBanco('João Schilian', 17, '123.456.789-00', 'Rua A, 123', '99999-9999')
cliente2 = ClienteBanco('Murillo Camillo', 17, '987.654.321-00', 'Av. B, 456', '88888-8888')
cliente3 = ClienteBanco('Anna Lucia', 17, '111.222.333-00', 'Trav. C, 789', '77777-7777')
...
cliente_vip = ClienteBancoVip('Anna VIP', 17, '111.222.333-00','Trav. C, 789', '77777-7777')
print(cliente_vip)